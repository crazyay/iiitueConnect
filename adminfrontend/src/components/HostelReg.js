...
function HostelReg() {
    ...
    const fetchRegistrations = async () => {
        try {
            ...
            const response = await fetch(
                `${apiUrl}/hostel/hostelregistration?${queryParams}`,
                {
                    headers: {
    ...
    const handleApprove = async (e, id) => {
        ...
        try {
            ...
            const response = await fetch(
                `${apiUrl}/hostel/hostelregistrationapproval/${id}`,
                {
                    method: 'PUT',
                    headers: {
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-12">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <h1 className="text-4xl font-bold mb-2">Hostel Registrations</h1>
                    <p className="text-xl opacity-90">Manage and approve student hostel registrations</p>
                </div>
            </div>
